    ...
    <div class="container">
      <div class="xs-heading row xs-mb-60">
        <div class="col-md-9 col-xl-9">
          ...
          <p>DelehdanaPress has built a platform focused on aiding entrepreneurs, startups, and <br> companies
         ...
         <Modal>
          ...
          <div class="xs-popular-item xs-box-shadow">
            <div class="xs-item-header">
              ...
              <div class="xs-skill-track" style="width:{calculateFounded(charity.pledged,charity.target)}%">
              <p in:fly="{{delay:3500,x:-100}}" style="left:100%"><span class="number-percentage-count number-percentage" data-value="90"
                  data-animation-duration="3500">{calculateFounded(charity.pledged,charity.target)}</span>%</p>
                </div>
              </div>
